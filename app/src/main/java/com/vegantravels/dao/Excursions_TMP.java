...
public class Excursions_TMP {
    ...
    public Excursions_TMP(Long id, int cruzeId, int title, String from, String to, String time, String price, int maxNumberOfGuest, long ExcursionUniqueId, long createdAt, long updatedAt) {
        this.id = id;
