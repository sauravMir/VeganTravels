...
/** 
 * DAO for table "CRIUZES__TMP".
*/
public class Criuzes_TMPDao extends AbstractDao<Criuzes_TMP, Long> {

    public static final String TABLENAME = "CRIUZES__TMP";

    /**
     * Properties of entity Criuzes_TMP.<br/>
    ...
    */
    ...
    public Criuzes_TMPDao(DaoConfig config) {
        super(config);
    }
    
    public Criuzes_TMPDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CRIUZES__TMP\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CRIUZES__TMP\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Criuzes_TMP entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Criuzes_TMP readEntity(Cursor cursor, int offset) {
        Criuzes_TMP entity = new Criuzes_TMP( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Criuzes_TMP entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Criuzes_TMP entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Criuzes_TMP entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
